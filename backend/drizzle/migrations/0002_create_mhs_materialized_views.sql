...
CREATE INDEX "mv_mhs_gender_angkatan_idx" ON "mv_mahasiswa_gender" ("angkatan");--> statement-breakpoint
CREATE INDEX "mv_mhs_agama_angkatan_idx" ON "mv_mahasiswa_agama" ("angkatan");--> statement-breakpoint
CREATE INDEX "mv_mhs_jalur_angkatan_idx" ON "mv_mahasiswa_jalur_daftar" ("angkatan");--> statement-breakpoint
CREATE INDEX "mv_mhs_total_angkatan_idx" ON "mv_mahasiswa_total_per_angkatan" ("angkatan");--> statement-breakpoint
CREATE INDEX "mv_mhs_slta_angkatan_idx" ON "mv_mahasiswa_slta_kategori" ("angkatan");--> statement-breakpoint
CREATE INDEX "mv_mhs_domisili_provinsi_idx" ON "mv_mahasiswa_domisili_kota" ("nama_provinsi");--> statement-breakpoint
